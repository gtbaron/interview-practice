...
public class JavaTreeTraversal {
    ...
    private String iterativeDepthFirstTraversal(Node root) {
        // evaluation order: data, left right
        return "not implemented";
    }

    private String breadthFirstTraversal(Node root) {
        // implement a breadth first traversal that
        // returns the node data in ascending order
        return "not implemented";
    }
